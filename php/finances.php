    ...
    onAuthorize: function(data, actions) {
      ...
      ?> 
		 ...
		 <button class="accordion">February</button>
           ...
           <div class="form">
                <form class="login-form" action="#">
      <p class="headers"> February 2022 Invoice </p>
  ...
  paypal.Button.render({
    ...
    onAuthorize: function(data, actions) {
      ...
      <button class="accordion">March</button>
           ...
           <div class="form">
                <form class="login-form" action="#">
       <p class="headers"> March 2022 Invoice </p>
...
<button class="accordion">April</button>
           ...
           <div class="form">
               <form class="login-form" action="#">
       <p class="headers"> April 2022 Invoice </p>
...
<button class="accordion">May</button>
           ...
           <div class="form">
               <form class="login-form" action="#">
       <p class="headers"> May 2022 Invoice </p>
...
<button class="accordion">June</button>
           ...
           <div class="form">
        <form class="login-form" action="#">
     <p class="headers"> June 2022 Invoice </p>
...
<button class="accordion">July</button>
           ...
           <div class="form">
  <form class="login-form" action="#">
       <p class="headers"> July 2022 Invoice </p>
  ...
  paypal.Button.render({
    ...
    onAuthorize: function(data, actions) {
      ...
      ?> 
           ...
           <div class="form">
          <form class="login-form" action="#">
       <p class="headers"> August 2022 Invoice </p>
  ...
  paypal.Button.render({
    ...
    onAuthorize: function(data, actions) {
      ...
      ?> 
           ...
           <div class="form">
          <form class="login-form" action="#">
       <p class="headers"> September 2022 Invoice </p>
  ...
  paypal.Button.render({
    ...
    onAuthorize: function(data, actions) {
      ...
      ?> 
           ...
           <div class="form">
          <form class="login-form" action="#">
       <p class="headers"> October 2022 Invoice </p>
  ...
  paypal.Button.render({
    ...
    onAuthorize: function(data, actions) {
      ...
      ?> 
           ...
           <div class="form">
          <form class="login-form" action="#">
       <p class="headers"> Novemeber 2022 Invoice </p>
  ...
  paypal.Button.render({
    ...
    onAuthorize: function(data, actions) {
      ...
      ?> 
           ...
           <div class="form">
          <form class="login-form" action="#">
       <p class="headers"> December 2022 Invoice </p>
